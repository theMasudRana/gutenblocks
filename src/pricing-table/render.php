...
>
	<div class="gtb-pricing">
		<?php if ($is_featured) : ?>
			<div class="gtb-pricing__featured">Featured</div>
		<?php endif; ?>
		...
		<?php if (!empty($features)) : ?>
			<ul class="gtb-pricing__features">
				<?php foreach ($features as $feature) : ?>
					<li class="pricing-table__feature"><?php echo esc_html($feature['text']); ?></li>
				<?php endforeach; ?>
			</ul>
		<?php endif; ?>

		<div class="gtb-pricing__button">
			<a href="<?php echo esc_url($button_url); ?>" class="gtb-pricing__button-link">
