...
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/utils */ "./src/pricing-table/utils/utils.js");
...
const Edit = ({
  ...
  const innerBlocksProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.useInnerBlocksProps)(blockProps, {
    allowedBlocks,
    template: _utils_utils__WEBPACK_IMPORTED_MODULE_1__["default"],
    templateLock: 'insert'
  });
...
/***/ "./src/pricing-table/utils/utils.js":
/*!******************************************!*\
  !*** ./src/pricing-table/utils/utils.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
