...
/***/ "./src/quiz/components/question.js":
/*!*****************************************!*\
  !*** ./src/quiz/components/question.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Question = ({
  ...
  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__.TextControl, {
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('SelectCorrect Answer', 'gutenblocks'),
...
/***/ "./src/quiz/components/quiz-select.js":
/*!********************************************!*\
  !*** ./src/quiz/components/quiz-select.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/add-submenu.js");
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/add-card.js");
/* harmony import */ var _components_question__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/question */ "./src/quiz/components/question.js");
/* harmony import */ var _components_quiz_select__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/quiz-select */ "./src/quiz/components/quiz-select.js");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./editor.scss */ "./src/quiz/editor.scss");
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./hooks */ "./src/quiz/hooks/index.js");
...
function Edit({
  ...
  const [showForm, setShowForm] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
...
const useQuizData = (id, onSaveSuccess) => {
  const [quizData, setQuizData] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(DEFAULT_QUIZ_STATE);
  const [error, setError] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [isSaving, setIsSaving] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  const fetchQuizData = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useCallback)(async quizId => {
    try {
      setError(null);
      ...
      setError((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Failed to load quiz data. Please try again.', 'gutenblocks'));
  ...
  const saveQuiz = async () => {
    ...
    try {
      ...
      setError((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Failed to save quiz. Please try again.', 'gutenblocks'));
    } finally {
      setIsSaving(false);
    }
  };
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"gutenblocks/quiz","version":"1.0.0","title":"GTB: Quiz","category":"widgets","icon":"forms","description":"Quiz block","example":{},"keywords":["quiz","gutenblocks"],"supports":{"html":false,"interactivity":true},"attributes":{"id":{"type":"number","default":0}},"textdomain":"gutenblocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScriptModule":"file:./view.js"}');
